...
<nav class="navbar navbar-dark bg-dark navbar-expand-md navbar-inverse navbar-fixed-top">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="nav-item active"><a class="nav-link" href="./register.php"><span class="glyphicon glyphicon-user"></span> Registrarse </a></li>
                <li class="nav-item"><a class="nav-link" href="./login.php"><span class="glyphicon glyphicon-log-in"></span> Ingresar </a></li>
            </ul>
        </div>
    </nav>
