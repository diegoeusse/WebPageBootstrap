...
<nav class="navbar navbar-dark bg-dark navbar-expand-md navbar-inverse navbar-fixed-top">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="nav-item active"><a class="nav-link" href="#"><span class="glyphicon glyphicon-user"></span> Sign
                        Up</a></li>
                <li class="nav-item"><a class="nav-link" href="./login.php"><span class="glyphicon glyphicon-log-in"></span>
                        Login</a></li>
            </ul>
        </div>
    </nav>
  ...
  <form method="post" action="register.php">
  	...
  	<p>
  		¿Ya tienes una cuenta? <a href="login2.php">Inicia sesión</a>
  	</p>
  </form>
