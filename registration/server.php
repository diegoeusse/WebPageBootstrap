...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($email)) { array_push($errors, "Se requiere un e-mail"); }
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	if (mysqli_num_rows($results) == 1) {
  	  $_SESSION['username'] = $username;
  	  $_SESSION['success'] = "Bienvenido a TooList";
  	  header('location: ./../index.php');
  	}else {
  		array_push($errors, "Combinación de usuario - contraseña inválida");
  	}
  }
}
