    ...
    <nav class="navbar navbar-dark bg-dark navbar-expand-md navbar-inverse navbar-fixed-top">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="nav-item"><a class="nav-link" href="./registration/login2.php"><span class="glyphicon glyphicon-log-in"></span>
                        Ingresar</a></li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="column">
                ...
                <div>
                    <a href="./catalogo.php"><button type="button" class="btn btn-primary"> Catálogos </button></a>
                </div>
            </div>
            <div class="column">
                <div class="section">
                ...
                <div>
                    <a href="./proveedores.php"><button type="button" class="btn btn-primary"> Proveedores
                        </button></a>
                </div>
            </div>
            <div class="column">
                ...
                <div>
                    <a href="./formulario.php"><button type="button" class="btn btn-primary"> Contáctanos </button></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="footer">
        <div class="row">
            <div class="column column-footer">
                ...
                <a href="http://www.instagram.com"><i class="fa fa-instagram media-icon" style="font-size:24px"></i></a>
