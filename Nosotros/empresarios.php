...
<body>
    ...
    <div class="row">
        <div class="card column">
            <div class="card-body">
                <img class="img-card-bot" src="./../Imágenes/Empresario.png" alt="Empresarios logo"
        ...
        <div class="card column">
            <div class="card-body">
                ...
                <h4 class="card-title">¿Qué ventajas tengo como empresario?</h4><br>
                ...
                <p class="card-text" style="text-align:justify"><li style="text-align:left"> Tus catálogos y productos harán parte de una de las mayores bases de datos de herramientas y maquinaria en Colombia.</li></p>

                <p class="card-text" style="text-align:justify"><li style="text-align:left"> Tendrás una mayor cantidad de clientes y de visualizaciones, al hacer parte de una comunidad más extensa.</li></p>

                <p class="card-text" style="text-align:justify"><li style="text-align:left"> Podrás mantenerte al día respecto a los precios y productos que ofrecen diferentes compañías para los productos que vendes.</li></p>

                <p class="card-text" style="text-align:justify"><li style="text-align:left"> Obtendrás sugerencias e informes detallados de tus ventas periódicamente.</li></p>

                <p class="card-text" style="text-align:justify"><li style="text-align:left"> Tendrás acceso a charlas y capacitaciones técnicas que permitan incrementar tus ganancias.</li></p><br>
