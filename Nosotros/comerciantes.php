...
<body>
    ...
    <div class="row">
        <div class="card column">
            <div class="card-body">
                <img class="img-card-bot" src="./../Imágenes/Comprador.png" alt="Comprador logo"
        ...
        <div class="card column">
            <div class="card-body">
                ...
                <h4 class="card-title">¿Qué ventajas tengo como comprador?</h4><br>
                ...
                <p class="card-text" style="text-align:justify"><li style="text-align:left"> Al comprar por nuestra página tienes asegurado el mejor servicio al cliente y una garantía mínima por tu adquisición.</li></p>

                <p class="card-text" style="text-align:justify"><li style="text-align:left"> Tu compra queda registrada en una base de datos, para mantenerte al día con todas las novedades y servicios que pueden ser de tu interés.</li></p>

                <p class="card-text" style="text-align:justify"><li style="text-align:left"> Conviértete en un cliente premium y tendrás acceso a más beneficios: regalos, extras, servicios de mantenimiento, repuestos y muchos más.</li></p><br>
